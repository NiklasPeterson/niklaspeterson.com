...
export default function Home() {
  ...
  return (
    <main className="w-full max-w-[1440px] flex flex-col">
      ...
      <MotionDown className='flex flex-col justify-center gap-4 px-4 h-[560px] sm:h-[640px] lg:px-20 md:py-32 md:h-[720px]'>
      ...
      <Motion className='flex w-full justify-between px-4 py-20 gap-10 flex-col-reverse md:flex-row lg:gap-40 lg:px-20 md:py-32'>
        <div className='flex flex-col gap-10 max-w-2xl'>
          ...
          <div className="flex gap-2">
            ...
            <a href="https://read.cv/niklaspeterson" className="h-10 text-sm btn-secondary">
            ...
            <div className='flex items-start flex-col gap-6'>
              ...
              {[
                ...
                <a href={url} target='_blank' rel='noopener' key={key}>
                  <div className='gap-2 items-center btn-link'>
                    {title}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                      <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
                    </svg>
        ...
        <div className='flex gap-5 flex-col md:gap-0 md:flex-row md:justify-between'>
          ...
          <div className='flex gap-2 text-zinc-950 dark:text-zinc-50'>
            {[
              ...
              <a className='p-2 btn-ghost' href={url} target='_blank' rel='noopener' key={key}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d={path} /></svg>
              </a>
            ))}
          </div>

          <small className='text-sm'><Link href="/">© {new Date().getFullYear()} Niklas Peterson</Link></small>
