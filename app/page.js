...
export default function Home() {
  ...
  return (
    <main className="w-full max-w-7xl flex flex-col">
      ...
      <nav className="w-full max-w-7xl  flex items-center justify-between py-4 absolute">
      ...
      <header className='flex flex-col gap-4 py-60'>
      <div className="absolute top-0 left-0 right-0 -z-10 blur-[200px]"><LottieAnimation/></div>
        <h1 className='text-[64px] font-bold leading-tight text-zinc-950 dark:text-zinc-50 max-w-4xl'>Bringing creativity to life through pixels and code</h1>
        <p className='text-2xl'>Niklas Peterson, <span className='font-semibold text-zinc-950 dark:text-zinc-50'>Product Designer</span> and founder from Sweden</p>
      </header>
      ...
      <section className='flex flex-wrap gap-10'>
        ...
        <div className='flex flex-col gap-4 w-full'>
          ...
          <div className='flex flex-col gap-1 max-w-xl'>
            <h4>Musho</h4>
            <p>Musho turns your prompts into nearly-complete, dev-ready websites with simple layouts, great copy, and gorgeous images.</p>
          </div>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex flex-col gap-1'>
            <h4>Hydrify</h4>
            <p>Your optimal hydration companion.</p>
          </div>
        </div>
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex flex-col gap-1'>
            <h4>Titls</h4>
            <p>Organize and categorize your home screens.</p>
          </div>
        </div>
      </section>

      <section className='flex w-full py-32 justify-between lg:gap-40'>

        <div className='flex flex-col gap-10 max-w-2xl'>
          <div className='flex flex-col gap-4'>
            <h3 className='text-6xl leading-tight font-bold text-zinc-950 dark:text-zinc-50'>About me</h3>
            <p className='text-xl'>
          ...
          <div className="flex gap-2">
            <a href="https://www.buymeacoffee.com/niklaspeterson" className="text-sm font-medium rounded-full h-10 px-5 py-3 flex gap-1 items-center text-zinc-50 bg-zinc-900 hover:bg-zinc-700 focus:outline-none focus:ring-4 focus:ring-zinc-300 dark:text-zinc-950 dark:bg-zinc-50 dark:hover:bg-zinc-200 dark:focus:ring-zinc-100">
            ...
            <a href="https://read.cv/niklaspeterson" className="text-sm font-medium rounded-full h-10 px-5 py-3 flex gap-1 items-center border border-zinc-900 text-zinc-950 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-zinc-200 dark:text-zinc-50 dark:border-zinc-50 dark:hover:bg-zinc-900 dark:focus:ring-zinc-700">
      ...
      <footer className='flex w-full flex-col gap-10 py-32 relative'>

        <div className='flex justify-between'>
          <div className='flex flex-col gap-4'>
            <h2 className='text-6xl leading-tight font-bold text-zinc-950 dark:text-zinc-50 max-w-xl'>Let's get to know each other!</h2>
            <p className='text-xl'>
          ...
          <div className='flex font-semibold gap-20 text-zinc-950 dark:text-zinc-50'>

            <div className='flex flex-col gap-6'>
              <div className='uppercase text-xs tracking-widest text-zinc-700 dark:text-zinc-300'>Side-projects</div>
              <a href='https://apps.apple.com/app/hydrify/id6450311759' target='_blank' rel='noopener'>
              ...
              <a href='https://apps.apple.com/app/titls/id1579078964' target='_blank' rel='noopener'>
                <div className='flex gap-2 items-center'>
                  Titls
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
              ...
              <a href='https://timestamps.app' target='_blank' rel='noopener'>
                <div className='flex gap-2 items-center'>
                  Timestamps
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
            ...
            <div className='flex flex-col gap-6'>
              <div className='uppercase text-xs tracking-widest text-zinc-700 dark:text-zinc-300'>Contact</div>
              <a href='mailto:hello@niklaspeterson.com' target='_blank' rel='noopener'>
                <div className='flex gap-2 items-center'>
                  Mail
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
              ...
              <a href='https://x.com/niklas_peterson' target='_blank' rel='noopener'>
                <div className='flex gap-2 items-center'>
                  x.com
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
              ...
              <a href='https://www.linkedin.com/in/niklaspeterson' target='_blank' rel='noopener'>
                <div className='flex gap-2 items-center'>
                  LinkedIn
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
