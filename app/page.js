        ...
        <div className='flex flex-col gap-20 md:justify-between md:flex-row'>
          ...
          <div className='flex font-medium gap-20 text-zinc-950 dark:text-zinc-50'>
            ...
            <div className='flex flex-col gap-6'>
              ...
              {[
                ['Hydrify', 'https://apps.apple.com/app/hydrify/id6450311759'],
                ['Titls', 'https://apps.apple.com/app/titls/id1579078964'],
                ['Timestamps', 'https://timestamps.app'],
              ].map(([title, url]) => (
            ...
            <div className='flex flex-col gap-6'>
              ...
              {[
                ['Mail', 'mailto:hello@niklaspeterson.com'],
                ['x.com', 'https://x.com/niklas_peterson'],
        ...
        <div className='flex gap-5 flex-col md:gap-0 md:flex-row md:justify-between'>
          ...
          <div className='flex gap-2 text-zinc-950 dark:text-zinc-50'>
            {[
              ...
              <a className='p-2 hover:opacity-60' href={url} target='_blank' rel='noopener'>
