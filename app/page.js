...
export default function Home() {
  ...
  return (
    <main className="w-full max-w-7xl flex flex-col">
      ...
      <Motion className='flex flex-col justify-center gap-4 px-4 h-[640px] lg:px-20 md:py-32 md:h-[720px]'>
        <div className="absolute top-0 left-0 right-0 -z-10 blur-[200px] max-w-full overflow-hidden"><LottieAnimation /></div>
  ...
  {[
    ...
    <a href={url} className="rounded-lg px-3 py-2 text-slate-700 font-medium hover:bg-slate-100 hover:text-slate-900">{title}</a>
          ...
          <div className="h-full absolute bottom-0 left-0 right-0 -z-10 blur-[200px] rotate-180 max-w-full overflow-hidden"><LottieAnimation /></div>
      </Motion>
