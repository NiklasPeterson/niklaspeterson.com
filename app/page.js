  ...
  return (
    <main className="w-full max-w-7xl flex flex-col">
      ...
      <nav className="w-full max-w-7xl  flex items-center justify-between py-4 absolute">
        <svg className='text-black dark:text-white' id="logo" width="58" height="40" viewBox="0 0 58 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <button type="button" className='text-base font-medium rounded-full px-5 py-3 flex gap-1 items-center text-zinc-50 bg-zinc-900 hover:bg-zinc-700 focus:outline-none focus:ring-4 focus:ring-zinc-300 dark:text-zinc-900 dark:bg-zinc-50 dark:hover:bg-zinc-200 dark:focus:ring-zinc-100'>
      ...
      <header className='flex flex-col gap-4 py-60'>
        <h1 className='text-6xl font-bold leading-tight text-black dark:text-white max-w-4xl'>Bringing creativity to life through pixels and code</h1>
        <p className='text-2xl'>Niklas Peterson, <span className='font-semibold text-black dark:text-white'>Product Designer</span> and founder from Sweden</p>
      </header>
      ...
      <section className='flex w-full py-32 justify-between lg:gap-40'>
        ...
        <div className='flex flex-col gap-10 max-w-2xl'>
          ...
          <div className="flex gap-2">
            <button type="button" className="text-sm font-medium rounded-full h-10 px-5 py-3 flex gap-1 items-center text-zinc-50 bg-zinc-900 hover:bg-zinc-700 focus:outline-none focus:ring-4 focus:ring-zinc-300 dark:text-zinc-900 dark:bg-zinc-50 dark:hover:bg-zinc-200 dark:focus:ring-zinc-100">
            ...
            <button type="button" className="text-sm font-medium rounded-full h-10 px-5 py-3 flex gap-1 items-center border border-zinc-900 text-zinc-900 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-zinc-200 dark:text-zinc-50 dark:border-zinc-50 dark:hover:bg-zinc-900 dark:focus:ring-zinc-700">
      ...
      <footer className='flex w-full flex-col gap-10 py-32'>

        <div className='flex justify-between'>
          <div className='flex flex-col gap-4'>
            <h2 className='text-6xl leading-tight font-bold text-zinc-900 dark:text-zinc-50 max-w-xl'>Let's get to know each other!</h2>
            <p className='text-xl'>
          ...
          <div className='flex font-semibold gap-20 text-black dark:text-white'>
