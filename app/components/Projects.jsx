...
export default function Projects() {
  ...
  return (
    <div className='flex flex-wrap gap-12 px-4 pb-20 lg:px-20 md:pb-32'>
      ...
      {selectedProject && (
        <div className="fixed bg-[rgba(0,0,0,0.25)] z-10 top-0 right-0 bottom-0 left-0 h-svh w-svw overflow-auto md:p-4">
          <div className="min-h-full flex flex-col rounded-2xl py-6 md:py-10 gap-10 bg-white dark:bg-black opacity-0 border dark:md:border-zinc-800 fade-slide-in">
            ...
            <div className={`flex flex-col md:flex-row px-4 md:px-10 gap-4 md:gap-6 items-center opacity-0 fade-slide-in fadeSlideInSequential-delay-01 md:overflow-x-scroll md:snap-x md:snap-mandatory`}>
