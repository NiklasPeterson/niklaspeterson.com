...
export default function Footer() {
  ...
  return (
    <FadeIn id="contact" className='flex w-full flex-col gap-10 relative px-4 my-20 lg:px-20 md:mt-32 scroll-mt-10'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex gap-2 text-zinc-950 dark:text-zinc-50'>
            {[
              ...
              <a className='btn-ghost p-2' href={url} target='_blank' rel='noopener noreferrer' key={key} aria-label={label}>
